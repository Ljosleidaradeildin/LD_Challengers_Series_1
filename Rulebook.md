...
## 2.1 Changes to the Rules

The Tournament Officials reserve the right to alter any parts of the rules at any time before or during the event if it is considered reasonably necessary. The Tournament Officials also reserve the right to make decisions based on their best judgement and the information available at the time of the decision, for cases not specifically detailed in this rulebook.

This Rulebook is subject to change at the sole discretion of the Tournament Officials.

## 2.2 Compliance

By participating in the tournament, players accept with no reservations all of the above and below mentioned regulations and that any decision made by the Tournament Officials during the tournament may at any time supersede these regulations.

Any concerns regarding the tournament integrity, including (but not limited to) suspected cheating, match-fixing, account sharing, etc may be submitted directly to the Tournament Manager.
...
The Invite Date will be announced on a per event basis, with a minimum of 2 months prior to the event’s start date.

Teams have 72 hours to accept an invite. Failure to respond within this timeframe will be considered a declined invite.
...
3. Any changes to the qualified roster must be pre-approved by Tournament Officials.

Teams that don’t meet these requirements may be disqualified or replaced without further notice.
...
The Publisher (Valve) reserves the right to remove any player or team from the tournament for any reason. In such a case, the player or team will be disqualified.
...
The tournament organiser has the right to protect its own products created during or after the tournament from rebroadcast or unauthorised usage in post-production.
...
Teams that accept a VRS Invite must maintain at least three (3) out of five (5) players from the VRS Core Roster used to secure the invite. This requirement applies to all matches in the tournament. Failure to meet this condition may result in the team being replaced or disqualified at the discretion of Tournament Officials.
...
- Offline matches (LAN)
  - Only the officially registered coach is permitted in the designated playing area or team booth during LAN matches.
  - Coaches are permitted to bring physical notes, notebooks, binders, or paper-based tactical blueprints into the playing area.
  - Coaches are strictly prohibited from observing the match via any official broadcast, secondary stream, or live data feed. A coach may only monitor the match by looking at their own player's monitors.
  - Coaches are strictly prohibited from physically touching players, shaking hands, fist-bumping, or making visible gestures or shouting at players while a live round is in progress.

- Authorized Communication Windows
  - Coaches are permitted to communicate verbally and via text with their players only during the following specified match phases.
    - Pre-Match Warmup: From the time players join the server until the live match starts.
    - Tactical Timeouts: During a team-called tactical timeout. Communication must cease immediately when the freezetime clock expires.
  ...
  - Coaches must maintain complete radio silence during active play. Once the freeze time of a round ends and the round officially begins, no communication (verbal, non-verbal, physical, or text) is allowed until the round concludes or a timeout is called.
 
- Infractions and Enforcement
  - Warning Protocol: A minor or first-time violation of coaching communication boundaries (e.g., speaking a few seconds into a live round or accidental physical contact) will result in an official verbal match warning  by the match referee.
  - Severe Penalties: Repeated infractions or deliberate breaches of competitive integrity will result in immediate escalation by the referees. Penalties may include, but are not limited to:
...
Teams are limited to five (5) minutes of technical pauses per map. After this time has run out a Team may use a tactical timeout to allow more time to resolve issues(s).

Teams are allowed to donate a portion of their technical time to their opponent during the match.

If an issue cannot be resolved within the allotted five (5) minutes, Team(s) can request additional time from an Admin via Discord. This additional time will be given at the discretion of the Admin dealing with the situation.
